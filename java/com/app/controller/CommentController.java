...
public class CommentController {
	...
	public String commentUpdate(HttpSession session, String uid, String mid,
			String content, String type, String created, String updated,
			String status, String reply, String id, Model model) {
